...
<script type="text/javascript">
	jQuery(function () {
        ...
        <div class="wrap before_after_wrapper before_and_after_settings">
		<?php else: ?>
		...
		<?php endif; ?>
			...
			<form method="post" action="options.php">
				...
				?>
				<?php
					// Output Contact Form 7 settings
...
?>
		...
		<div id="signup_wrapper">
			<div class="topper yellow_orange_bg">
				<h3>Upgrade To Before &amp; After Pro!</h3>
				<p class="pitch">When you upgrade, you'll instantly unlock conversion tracking, notification emails, HubSpot integration, personalized support, and more!</p>
				<a class="upgrade_link" href="http://goldplugins.com/our-plugins/before-and-after/?utm_source=cpn_box&utm_campaign=upgrade&utm_banner=learn_more" title="Learn More">Learn More About Before &amp; After Pro &raquo;</a>
			</div>
			<div id="mc_embed_signup">
				...
				<form action="" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
					...
					<input type="hidden" id="mc-upgrade-link-per" value="http://goldplugins.com/purchase/before-after-pro/single?promo=newsub10" />
					<input type="hidden" id="mc-upgrade-link-biz" value="http://goldplugins.com/purchase/before-after-pro/business?promo=newsub10" />
					<input type="hidden" id="mc-upgrade-link-dev" value="http://goldplugins.com/purchase/before-after-pro/developer?promo=newsub10" />
