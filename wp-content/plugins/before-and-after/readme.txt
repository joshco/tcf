...
= 2.5.11 =
* Adds Goals to Menus interface.

= 2.5.10 =
* Adds Single View support for Goals

= 2.5.9 =
* Add redundant cookie option for goal completions.

= 2.5.8 =
* Automatically refresh the page when CF7 forms are completed. Can be disabled via new option.

= 2.5.7 =
* Compatibility update for WP 4.4.2
