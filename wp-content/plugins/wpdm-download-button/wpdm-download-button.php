...
<table id="allbtns" class="table table-striped">
    ...
    <tr><th colspan="3"><b>Bootstrap Buttons ( CSS )</b></td></tr>
    ...
    <tr><td><button type="button" class="btn btn-primary btn-lg">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-primary-lg'?'checked=checked':''); ?> value='bs-primary-lg' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn'  <?php echo (get_option('wpdm_dlbtn')=='bs-primary-lg'?'checked=checked':''); ?> value='bs-primary-lg' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-info btn-lg">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-info-lg'?'checked=checked':''); ?> value='bs-info-lg' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-info-lg'?'checked=checked':''); ?> value='bs-info-lg' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-warning btn-lg">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-warning-lg'?'checked=checked':''); ?> value='bs-warning-lg' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-warning-lg'?'checked=checked':''); ?> value='bs-warning-lg' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-success btn-lg">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-success-lg'?'checked=checked':''); ?> value='bs-success-lg' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-success-lg'?'checked=checked':''); ?> value='bs-success-lg' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-danger btn-lg">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-danger-lg'?'checked=checked':''); ?> value='bs-danger-lg' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-danger-lg'?'checked=checked':''); ?> value='bs-danger-lg' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-inverse btn-lg">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-inverse-lg'?'checked=checked':''); ?> value='bs-inverse-lg' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-inverse-lg'?'checked=checked':''); ?> value='bs-inverse-lg' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>


    <tr><td><button type="button" class="btn btn-primary btn-xs">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-primary-xs'?'checked=checked':''); ?> value='bs-primary-xs' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn'  <?php echo (get_option('wpdm_dlbtn')=='bs-primary-xs'?'checked=checked':''); ?> value='bs-primary-xs' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-info btn-xs">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-info-lg'?'checked=checked':''); ?> value='bs-info-xs' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-info-lg'?'checked=checked':''); ?> value='bs-info-xs' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-warning btn-xs">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-warning-xs'?'checked=checked':''); ?> value='bs-warning-xs' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-warning-xs'?'checked=checked':''); ?> value='bs-warning-xs' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-success btn-xs">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-success-xs'?'checked=checked':''); ?> value='bs-success-xs' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-success-xs'?'checked=checked':''); ?> value='bs-success-xs' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-danger btn-xs">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-danger-xs'?'checked=checked':''); ?> value='bs-danger-xs' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-danger-xs'?'checked=checked':''); ?> value='bs-danger-xs' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
    <tr><td><button type="button" class="btn btn-inverse btn-xs">Link Label</button></td><td><input  name='wpdm_dlbtn_lt' type='radio' <?php echo (get_option('wpdm_dlbtn')=='bs-inverse-xs'?'checked=checked':''); ?> value='bs-inverse-xs' id='blt<?php echo (++$zc); ?>' /></td><td><input name='wpdm_dlbtn' <?php echo (get_option('wpdm_dlbtn')=='bs-inverse-xs'?'checked=checked':''); ?> value='bs-inverse-xs' type="radio" id='b<?php echo (++$zc); ?>' /></td></tr>
...
function wpdm_apply_image_button($label, $package){
    ...
    return $img?"<img src=\"{$imgrl}\" alt=\"{$label}\" />":$label;
}
...
add_filter('wpdm_after_prepare_package_data','wpdm_custom_download_button');
